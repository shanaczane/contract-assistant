...
function AskButton({ section, onAsk }: { section: string; onAsk?: (q: string) => void }) {
  ...
  return (
    <button
      ...
      className="print:hidden inline-flex items-center gap-1 text-xs text-brand-muted hover:text-brand-primary transition-colors mt-3"
    >
        ...
        <div className="space-y-4 print:space-y-0">
          ...
          <div className="print:hidden flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-lg border border-brand-border text-brand-muted hover:border-brand-primary hover:text-brand-primary transition-colors"
            >
