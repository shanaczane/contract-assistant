        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {INFO_CARDS.map(({ label, key }) => (
              <div key={label} className="bg-brand-surface rounded-2xl border border-brand-border p-5">
                ...
                {analysis[key] ? (
                  ...
                  <p className="text-sm text-brand-muted">Not specified</p>
                )}
              </div>
            ))}
          </div>
          ...
          {analysis.redFlags && (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <svg className="w-4 h-4 text-brand-danger shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
